...
import classicupdaterapp.customTypes.FullUpdateInfo;
import classicupdaterapp.customTypes.UpdateInfo;
import classicupdaterapp.customization.Customization;
import classicupdaterapp.listadapters.UpdateListAdapter;
import classicupdaterapp.misc.Constants;
import classicupdaterapp.misc.Log;
import classicupdaterapp.misc.State;
import classicupdaterapp.tasks.ChangelogTask;
import classicupdaterapp.tasks.MD5CheckerTask;
import classicupdaterapp.tasks.UpdateCheckTask;
import classicupdaterapp.tasks.ChangelogTask.ChangelogType;
import classicupdaterapp.utils.Preferences;
import classicupdaterapp.utils.StringUtils;
import classicupdaterapp.utils.SysUtils;
import classicupdaterapp.utils.UpdateFilter;
...
public class MainActivity extends Activity {
    ...
    public void updateLayout() {
        ...
        if (mUpdateFolder.exists() && mUpdateFolder.isDirectory() && files != null && files.length > 0) {
            //To show only the Filename. Otherwise the whole Path with /sdcard/classic-updates will be shown
